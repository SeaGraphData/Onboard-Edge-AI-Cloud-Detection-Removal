...
WEIGHTS  = f"{PROJECT_ROOT}/weights/unet_checkpoint.h5"
...
def compute_flops():
    ...
    with graph.as_default():
        fresh_model = Unet(input_res=256, activation="relu",
...
def evaluate_unet():
    print("=" * 60)
    print("UNET EVALUATION — Jetson Orin Nano")
    print("=" * 60)
    ...
    model = Unet(input_res=256, activation="relu",
               activation_out="sigmoid", seed=42)
    ...
    out_path = os.path.join(OUT_DIR, "unet_jetson.json")
