...
# Paths
WEIGHTS = "/scratch/users/jfernandezmartinez/CloudGAN/output/UNet/checkpoint.h5"
...
def evaluate_unet():
    ...
    model = Unet(input_res=256, activation="relu", activation_out="sigmoid", seed=42)
    ...
    with open(os.path.join(OUT_DIR, "unet_full.json"), "w") as f:
        json.dump(results, f, indent=2)

    with open(os.path.join(OUT_DIR, "unet_full.txt"), "w") as f:
        f.write("UNET FULL EVALUATION\n")
